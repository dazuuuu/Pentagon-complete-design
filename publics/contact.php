    ...
    <div class="row g-5">
      <div class="col-lg-7 reveal">
        <div style="background: #fff; padding: 40px; border-radius: var(--radius-md); box-shadow: 0 20px 40px rgba(0,0,0,0.05);">
          ...
          <div style="background: #8a1f1f; color: #fff; padding: 20px; border-radius: var(--radius-md); margin-bottom: 24px;">
            <strong>Please check your details</strong> and try sending the enquiry again.
          </div>
          <?php endif; ?>
          ...
          <form method="POST" action="<?php echo $base; ?>handlers/index.php">
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <textarea name="message" style="width: 100%; padding: 20px; border-radius: 20px; border: 1px solid #ddd; outline: none;" rows="5"></textarea>
              </div>
              <div class="col-12">
