...
class OfferingService
{
    ...
    private function fallbackOfferings(): array
    {
        return [
            ...
            ['title' => 'Cultural Immersions', 'description' => 'Authentic encounters with Maasai and other communities connecting you to living heritage.'],
            ['title' => 'Photography Safaris', 'description' => 'Specialist expeditions led by professionals with photography-optimised vehicles.'],
            ['title' => 'Luxury Lodge Bookings', 'description' => 'Exclusive access to Africa\'s finest eco-lodges and private conservancies.'],
        ];
    }
}
