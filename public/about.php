    ...
    <div class="row g-4">
      ...
      <div class="col-lg-4 col-md-6 reveal">
        <div style="background: #fff; padding: 40px; border-radius: var(--radius-md); height: 100%; border-bottom: 4px solid var(--gold);">
          <h4 style="margin-bottom: 16px; color: var(--green);"><?php echo htmlspecialchars($p['title']); ?></h4>
          <p style="font-size: 0.95rem;"><?php echo htmlspecialchars($p['desc']); ?></p>
        </div>
      </div>
      <?php endforeach; ?>
    </div>
